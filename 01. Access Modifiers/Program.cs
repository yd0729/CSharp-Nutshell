...
class Class1
{
} // Class1 is internal (default) - visible to other types in same assembly

public class Class2
{
} // Class2 is visible to everything, including types in other assemblies
...
class BaseClass
{
    ...
    protected void Bar()
    {
    } // Foo is accessible to subclasses
}
